...
namespace App\Filament\CompanyOwner\Resources\OfferResource\Pages;

use App\Filament\CompanyOwner\Resources\OfferResource;
    ...
    public function getTabs(): array
{
    return [
        ...
        'active_offers' => \Filament\Resources\Components\Tab::make('العروض الحالية')
            ...
            // هون التعديل: بنفلتر الحقل end_date مباشرة
